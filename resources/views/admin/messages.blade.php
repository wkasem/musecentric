...
<div class="row" v-if='conversations.length != 0'>
  <div class="loading-messages" v-if="loading_messages">
  ...
  <div class="col s3">
    <div class="collection">
        <a href="#" class="collection-item @{{(c.conversation_id == current_conversation.conversation_id) ? 'active' : ''}}"  v-for='c in conversations' v-on:click.prevent='changeBoard($event , c)'>
  ...
  <div class="col s9" v-if='current_conversation'>
    <div class="row" style="width:100%;">
      ...
      <div class="input-filed col s12 card z-depth-0">
        <form v-on:submit.prevent='sendMsg($event)'>
